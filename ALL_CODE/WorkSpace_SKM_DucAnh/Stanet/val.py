...
#     opt.dataroot = r'E:\WorkSpaceSkyMap\Change_detection_Dubai\DataTraining\V1\cut256stride128\SplitTrainValTest_addthem_cai_cu\test'
#     opt.name = 'DUBAI-tonghopQC_ok'
#     opt.epoch = '113_F1_1_0.72993'
#     opt.num_test = np.inf
...
if __name__ == '__main__':
    ...
    opt.dataroot = r'E:\WorkSpaceSkyMap\Change_detection_Dubai\DataTraining\V1\cut256stride128\SplitTrainValTest_addthem_cai_cu\test'
    opt.n_class = 2
    opt.SA_mode = 'BAM' # BAM | PAM 
    opt.arch = 'mynet3'
    opt.model = 'CDF0' # model type
    opt.name = 'DUBAI-tonghopQC_ok'
