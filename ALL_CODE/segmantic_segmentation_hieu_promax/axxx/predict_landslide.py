                ...
                for x_, y_, x_c, y_c, s_x, s_y in l_coor:
                    ...
                    if np.count_nonzero(img_d) > 0:
                        if len(np.unique(img_d)) <= 2:
                            ...
                            y_P = (y_P[0,...,0] > config.value).astype(np.uint8)
...
if __name__=="__main__":
    ...
    fp_predict = r'/home/skm/SKM16/X/Lo/Full_Images_LandslideDetection_8bit_perimage/bo_them_nodata/Img_uint8_crop/aaaxxx.tif'
    size_model = 128
