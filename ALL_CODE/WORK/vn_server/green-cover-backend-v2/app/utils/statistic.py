...
def calculate_metadata(file_path, geometry=None):
    ...
    try:
        meta["PIXEL_SIZE_X_METER"] = geopy.distance.vincenty(coords_origin, coords_right).km * 1000
        meta["PIXEL_SIZE_Y_METER"] = geopy.distance.vincenty(coords_origin, coords_bottom).km * 1000
    except Exception:
