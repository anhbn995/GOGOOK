...
from green_cover.detect_green import main_green
from green_cover.detect_water import main_water
from green_cover.models.models import unet_3plus, att_unet
...
def run_segmentation(img, weight_path_green, weight_path_water, result_path, dil=False, run_agian=False):
    ...
    with rasterio.open(img) as src:
        ...
        sieved_msk = sieve(new_msk, size=300)
        index_nodata = np.where(sieved_msk == 0)
    return result_green, result_water, index_nodata
