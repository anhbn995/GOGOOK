...
Cách chạy file train.py

# mo hinh tot
# Bahrain1
python train.py --save_epoch_freq 1 --angle 15 --dataroot /home/skm/SKM16/Tmp/DATA_TRAIN_BUILDING/train --val_dataroot /home/skm/SKM16/Tmp/DATA_TRAIN_BUILDING/val --name Bahrainaa --lr 0.001 --model CDF0  --batch_size 10 --load_size 512 --crop_size 512 --preprocess rotate_and_crop

"""
"""
India
python train.py --save_epoch_freq 1 --angle 15 --dataroot /home/skm/SKM16/Data/WORK/MSRAC/Unstak/uint8/Img_cut/zgen_cut256stride250/SplitTrainValTest/train --val_dataroot /home/skm/SKM16/Data/WORK/MSRAC/Unstak/uint8/Img_cut/zgen_cut256stride250/SplitTrainValTest/val --name India_256 --lr 0.001 --model CDF0  --batch_size 10 --load_size 256 --crop_size 256 --preprocess rotate_and_crop
"""

"""
--dataroot E:\WorkSpaceSkyMap\Change_detection_Dubai\DataTraining\V1\cut256stride128\SplitTrainValTest_addthem_cai_cu\train 
--val_dataroot E:\WorkSpaceSkyMap\Change_detection_Dubai\DataTraining\V1\cut256stride128\SplitTrainValTest_addthem_cai_cu\val 
...
"""
# day là các model khác nhau có thể nâng cao hơn.
"""
...
# # mo hinh tot cua Dubai v512
# python train.py --save_epoch_freq 1 --angle 15 --dataroot /home/skm/SKM16/Tmp/cut512stride400/SplitTrainValTest/train --val_dataroot /home/skm/SKM16/Tmp/cut512stride400/SplitTrainValTest/val --name Dubai_change_CDF0_ver512 --lr 0.001 --model CDF0  --batch_size 2 --load_size 512 --crop_size 512 --preprocess rotate_and_crop
