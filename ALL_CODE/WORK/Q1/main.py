...
import norm_train
from savebest import SavebestweightsandEarlyStopping
...
def main(mission, use_model, img_path, shp_path, box_path, old_weights):
    ...
    config_path = os.path.join('/home/skm/SKM/WORK/ALL_CODE/WORK/Q1/configs', '%s.json'%(use_model))
    ...
    data_path = os.path.join(os.path.join('/home/skm/SKM/WORK/ALL_CODE/WORK/Q1/data', mission))
    checkpoint_filepath = os.path.join('/home/skm/SKM/WORK/ALL_CODE/WORK/Q1/logs', mission, 'tmp')
    log_dir = os.path.join('/home/skm/SKM/WORK/ALL_CODE/WORK/Q1/logs', mission, 'graph')
    weights_path = os.path.join('/home/skm/SKM/WORK/ALL_CODE/WORK/Q1/weights', '%s'%(use_model), use_model+'_'+mission+'_'+str(total_stragegy['img_size'])+'_'+str(dict_params['n_labels'])+'class.h5')
    patience = 10
