...
class PolypDataset(data.Dataset):
    ...
    def __init__(self, image_root, gt_root, trainsize, augmentations):
        ...
        print(self.augmentations, "duc anh")
        self.images = [image_root + f for f in os.listdir(image_root) if f.endswith('.tif') or f.endswith('.tif')]
        self.gts = [gt_root + f for f in os.listdir(gt_root) if f.endswith('.tif')]
        # print(self.images, "duc anhaaaa")
        self.images = sorted(self.images)
        self.gts = sorted(self.gts)
        # self.filter_files()
        # print(self.images, "duc anh2")
        ...
        if self.augmentations == True:
            ...
            self.img_transform = transforms.Compose([
                ...
                transforms.ToTensor(),
                transforms.Normalize([0.485, 0.456, 0.406, 0.449],
...
class test_dataset:
    def __init__(self, image_root, gt_root, testsize):
        ...
        self.images = [image_root + f for f in os.listdir(image_root) if f.endswith('.tif') or f.endswith('.tif')]
        self.gts = [gt_root + f for f in os.listdir(gt_root) if f.endswith('.tif') or f.endswith('.tif')]
        self.images = sorted(self.images)
        self.gts = sorted(self.gts)
