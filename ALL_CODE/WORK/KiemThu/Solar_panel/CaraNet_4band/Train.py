...
def train(train_loader, model, optimizer, epoch, test_path):
    ...
    for i, pack in enumerate(train_loader, start=1):
        for rate in size_rates:
            ...
            # ---- forward ----
            # print(images.shape,"zzzzzzzzzzzzzzzzzz")
    ...
    if (epoch+1) % 1 == 0:
        ...
        if meandice > float(best):
            ...
            best = fp.read()
            fp.close()
            torch.save(model.state_dict(), save_path + f'CaraNet-best-solar4band-BTHG-HOA-{epoch}.pth' )
            print('[Saving Snapshot:]', save_path + f'CaraNet-best-solar4band-BTHG-HOA-{epoch}.pth', meandice,'[best:]',best)
...
if __name__ == '__main__':
    ...
    parser.add_argument('--train_path', type=str,
                        # default='/home/skm/SKM/WORK/ALL_CODE/WORK/KiemThu/data/TrainDataset/', help='path to train dataset')
                        # default='/home/skm/SKM16/Work/SonalPanel_ThaiLand/1Ver2_lable2/izmages_8bit_perizmage/Data_Train_and_Model/crop_512/Train/', help='path to train dataset')
                        default='/home/skm/SKM16/Work/SonalPanel_ThaiLand/1Ver2_lable2/V2/Data_Train_and_Model/Crop_512_per1_98/Train/', help='path to train dataset')
    parser.add_argument('--test_path', type=str,
                        # default='/home/skm/SKM/WORK/ALL_CODE/WORK/KiemThu/data/TestDataset/CVC-300/' , help='path to testing Kvasir dataset')
                        # default='/home/skm/SKM16/Work/SonalPanel_ThaiLand/1Ver2_lable2/izmages_8bit_perizmage/Data_Train_and_Model/crop_512/Test/' , help='path to testing Kvasir dataset')
                        default='/home/skm/SKM16/Work/SonalPanel_ThaiLand/1Ver2_lable2/V2/Data_Train_and_Model/Crop_512_per1_98/Test/' , help='path to testing Kvasir dataset')
    
    parser.add_argument('--train_save', type=str,
                        default='CaraNet-best-solar4band_512_CAI_NAY_BTH_HOA_v2')
