...
def store_cloud(file_path, month, year, src, aoi):
    ...
    # gdf.to_file("/home/skm/Downloads/gpd.shp")
    # df.to_file("/home/skm/Downloads/df.shp")
    ...
    if not clip.empty:
        ...
        print("aaaaaaaaaaaaaaaaaaaaa", aoi['id'])
...
if __name__ == '__main__':
    ...
    store_cloud('/home/geoai/geoai_data_test2/data_npark/Sentinel/cloud/2021_T1.shp',
                2021, '01', 'Sentiel', 14)
    year = 2021
    # list_geojson = [
    #     {
