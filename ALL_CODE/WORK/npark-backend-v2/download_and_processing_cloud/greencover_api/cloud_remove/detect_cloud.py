...
# -*- coding: utf-8 -*-
"""
Created on Tue Nov 7 23:25:42 2022
...
def main_predict_cloud(dir_img_float, fp_mode):
    ...
    # print(fp_mode, "zzzzzzzzzzzzzxxxx")
    # fp_mode = r"/home/skm/SKM16/IMAGE/npark/npark-backend-v2/weights/cloud_weights.h5"
    cnn_model = tf.keras.models.load_model(fp_mode)
    ...
    for fname in list_name_file:
        ...
        if os.path.exists(out_file):
            ...
            predict_all_2(in_file, out_file, cnn_model)
