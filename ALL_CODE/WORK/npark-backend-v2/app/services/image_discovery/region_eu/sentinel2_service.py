...
class DiscoverySentinel2(ImageDiscoveryEu):
    ...
    def prepare(self):
        ...
        self.processing_level = self._kwargs.get('processing_level')
        self.product = 'Sentinel2'
    ...
    def transform(self):
        ...
        for list_item in list(itertools.chain(*self.list_items)):
            for feature in list_item:
                result.append({
                    'id': feature['properties']['title'].split('.')[0],
