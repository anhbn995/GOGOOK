...
for path_image in list_fp:
    if path_image.find('_mask.tif') != -1:
        ...
        path_predict = os.path.join(r"/home/skm/SKM16/Work/SonalPanel_ThaiLand/1Ver2_lable2/izmages_8bit_perizmage/images_per95/build_model", os.path.basename(path_image))
