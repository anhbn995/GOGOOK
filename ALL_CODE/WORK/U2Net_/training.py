...
class DataParser():
    ...
    def get_batch(self, batch):
        ...
        for img_list in batch:
            im = np.load(img_list)[...,:4]#.transpose(1,2,0)[...,:3]
...
if __name__ == '__main__':
    ...
    path1 = glob.glob('/home/skm/SKM16/Work/SonalPanel_ThaiLand/1Ver2_lable2/izmages_8bit_perizmage/Data_Train_and_Model/U2netV2/npy_i_256/*.npy')
    np.random.shuffle(path1)
    ...
    TRAIN_LOGDIR = '/home/skm/SKM/WORK/ALL_CODE/WORK/U2Net_/logs/logs'
    # TRAIN_LOGDIR = '/home/skm/SKM16/ALL_MODEL/Semantic_segmentation/U2net/SolarPanel2/logs'
    TRAIN_EPOCHS = 50
    best_val_loss = 10
    ...
    for epoch in range(TRAIN_EPOCHS):
        ...
        with tqdm(total=len_val,desc=f'Val',postfix=dict,mininterval=0.3) as pbar:
            ...
            if best_val_loss>=total_val/len_val:
                # my_model.save_weights(os.path.join("/home/skm/SKM16/IMAGE/ZZ_ZZ/cloud_shadow/U2net/data_train_bo_dagood/model_256_good_boda", f"model_u2net_256_boda_good.h5"))
                my_model.save_weights(os.path.join("/home/skm/SKM/WORK/ALL_CODE/WORK/U2Net_/logs", f"model_U2net_256_boda_good_binarycross_entropy_50.h5"))
                # my_model.save_weights(os.path.join("/home/skm/SKM16/ALL_MODEL/Semantic_segmentation/U2net/SolarPanel2", "model_U2net_256_soanl_good_binarycross_entropy_50.h5"))
