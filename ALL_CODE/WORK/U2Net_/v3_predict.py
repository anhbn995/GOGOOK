...
out_pre = r"/home/skm/SKM16/Work/SonalPanel_ThaiLand/1Ver2_lable2/V2/image_8bit_perimage_p98/SolarPanel_4band_512modelsize_pre_process_binary_cross_entropy"
os.makedirs(out_pre, exist_ok=True)

# model_path2 = '/home/skm/SKM16/ALL_MODEL/Semantic_segmentation/U2net/SolarPanel_4band_512modelsize/u2net_solarpanel.h5'
model_path2 = '/home/skm/SKM16/ALL_MODEL/Semantic_segmentation/U2net/SolarPanel_4band_512modelsize_pre_process_binary_cross_entropy/u2net_solarpanel.h5'
model2 = Model_U2Net(512, 4)
model2.load_weights(model_path2)
...
for path_image in tqdm(list_fp):
    if path_image.find('_mask.tif') != -1:
        ...
        path_predict = os.path.join(out_pre, os.path.basename(path_image))
