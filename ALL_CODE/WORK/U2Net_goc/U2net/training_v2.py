...
if __name__ == '__main__':
    ...
    data_train = glob.glob('/media/skymap/Nam/tmp_Nam/pre-processing/farm_all/data_train_v2/train/image/*.npy')
    data_val = glob.glob('/media/skymap/Nam/tmp_Nam/pre-processing/farm_all/data_train_v2/val/image/*.npy')
    ...
    for epoch in range(TRAIN_EPOCHS):
        ...
        with tqdm(total=len_val,desc=f'Val',postfix=dict,mininterval=0.3) as pbar:
            ...
            if best_val_loss>=total_val/len_val:
                my_model.save_weights(os.path.join("/media/skymap/Nam/tmp_Nam/pre-processing/farm_all/weight_aus", f"u2net.h5"))
