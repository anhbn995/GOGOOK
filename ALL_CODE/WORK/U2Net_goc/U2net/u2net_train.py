...
if __name__== "__main__":
    ...
    callbacks = [
        tf.keras.callbacks.TensorBoard(log_dir='log', histogram_freq=0, write_graph=True, write_images=False),
        tf.keras.callbacks.ModelCheckpoint(os.path.join('log', "model{epoch:02d}.h5"), verbose=0, save_weights_only=True, save_best_only = True),
    ]
