...
SQLALCHEMY_DATABASE_URI = "postgres://postgres:postgres@23.106.120.91/npark2"

# SQLALCHEMY_DATABASE_URI = "postgres://postgres:admin_123@192.168.4.100/nparks_singapore_prod"
...
# HOSTED_ENDPOINT = "http://192.168.4.100:8000/api/v1"
