...
#     model.load_weights(model_path)
    ...
    # model_path1 = '/mnt/data/Nam_work_space/model/model_u2net.h5'
    # model_path1 = '/mnt/data/Nam_work_space/model/u2net_farm_v3.h5'
    # model1 = Model_U2Net(480, 3)
    # model1.load_weights(model_path1)
    
    # model_path2 = '/mnt/data/Nam_work_space/model/Adalsn.h5'
    # model_path2 = '/mnt/data/Nam_work_space/model/adalsn_farm_v3.h5'
    ...
    # out_folder = '/mnt/data/farm_ggmap/predict/v6/'
    ...
    #         try:
    #             input_path = _file
    #             output_path = out_folder+os.path.basename(_file)
    ...
    input_path = '/mnt/data/public/farm_uint16/mos_neighbor_8u.tif'
    output_path = '/mnt/data/public/farm_uint16/test1.tif'
    predict_farm(input_path, output_path, model2)