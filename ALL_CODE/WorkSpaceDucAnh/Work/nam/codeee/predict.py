...
def nms_result(list_polygons, list_scores, list_labels, iou_threshold=0.3):
    ...
    result = tf.image.non_max_suppression(np.array(list_bound), np.array(list_scores), len(list_scores),iou_threshold=iou_threshold)
...
#     image_path = r'/media/skymap/Learnning/public/DA/1_TreeCounting_All_DATA/_tmp_Nam/object_cut/USA/box_7.tif'
    # image_path = r'/home/skm/SKM_OLD/ZZ_ZZ/TauBien/DaNang_23_07_2009_LowAccuracy.tif'
    # model_path = r'/home/skm/SKM/nam/codeee/ship20220306T2132/mask_rcnn_ship_0421.h5'
    # output_path = r'/home/skm/SKM_OLD/public/tmp_Nam/data/result/v7_DaNang_23_07_2009_LowAccuracy.shp'
    # predict_main(image_path, model_path, output_path, bound_path=None, out_type="a",verbose=1)

    image_path = r'/home/skm/SKM16/X/CuLaoCham/newtask_zoom_19.tif'
    model_path = r'/home/skm/SKM/nam/codeee/ship20220306T2132/mask_rcnn_ship_0499.h5'
    output_path = r'/home/skm/SKM16/X/CuLaoCham/v7_newtask_zoom_19.shp'
    predict_main(image_path, model_path, output_path, bound_path=None, out_type="a",verbose=1)