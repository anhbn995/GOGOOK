...
if __name__=="__main__":
    img_path = r'/home/quyet/DATA_ML/WorkSpace/classification_agricultural/download_tiles/downloads/bing/tif'
    out_path = r'/home/quyet/DATA_ML/WorkSpace/classification_agricultural/download_tiles/downloads/bing/farm_boundary'
    ...
    input_paths =  glob.glob(os.path.join(img_path, '*.tif'))

    if isinstance(input_paths, list):
        for input_path in input_paths:
            cache_path = os.path.join(out_path, os.path.basename(input_path))
            vector_path = cache_path.replace('.tif', '.geojson')
            
            predict_farm(model_farm, input_path, cache_path, size)
            raster_to_vector(cache_path, vector_path, threshold_distance, threshold_connect)
