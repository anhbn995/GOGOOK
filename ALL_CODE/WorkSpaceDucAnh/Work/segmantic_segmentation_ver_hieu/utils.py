...
def gen_trainning_dataset(image_crop_dir, mask_crop_dir, output_dir, sampleSize=128):
...
def get_range_value(img, val=15000, numbands=3):
...
def get_data(path_train, size=128, numbands=3, train=True):
    ...
    for n, id_ in enumerate(ids):
        ...
        x_img = get_range_value(x_img, numbands)
