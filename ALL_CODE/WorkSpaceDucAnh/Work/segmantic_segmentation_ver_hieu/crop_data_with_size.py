...
if __name__=='__main__':
    base_path = "/home/skm/SKM16/X/Landslide_Sentinel-2_DAnh/Training_ver_5band_goc/img_stack"
    # image_path = "/mnt/D850AAB650AA9AB0/changedetection/SLA/image"
    mask_path = "/home/skm/SKM16/X/Landslide_Sentinel-2_DAnh/Training_ver_5band_goc/label_255"
    outputFolder='/home/skm/SKM16/X/Landslide_Sentinel-2_DAnh/Training_ver_5band_goc/training_dataset_5band_goc'
    list_id = create_list_id(base_path)
    for image_id in list_id:
        basefile=os.path.join(base_path,image_id+".tif")
        # imagefile=os.path.join(image_path,image_id+".tif")
