...
if __name__ == '__main__':
    ...
    data_train = glob.glob('/media/skymap/Nam/tmp_Nam/segment_VN/data_train/train/image/*.npy')
    data_val = glob.glob('/media/skymap/Nam/tmp_Nam/segment_VN/data_train/val/image/*.npy')
    ...
    TRAIN_LOGDIR = '/media/skymap/Nam/tmp_Nam/model_segmentation/weights/VN/'
    TRAIN_EPOCHS = 50
    best_val_loss = 10
    ...
    for epoch in range(TRAIN_EPOCHS):
        ...
        with tqdm(total=len_val,desc=f'Val',postfix=dict,mininterval=0.3) as pbar:
            ...
            if best_val_loss>=total_val/len_val:
                my_model.save_weights(os.path.join("/media/skymap/Nam/tmp_Nam/model_segmentation/weights/VN/", f"u2net.h5"))
