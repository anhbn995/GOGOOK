...
def build_model(input_shape, n_filters, DropoutRatio=0.3):
    ...
    output_layer_noActi = layers.Conv2D(3, (1, 1), padding="same", activation=None)(uconv1) # change filter number
    ...
    model.compile(optimizer=optimizer,
                loss=losses,                
                metrics=['accuracy', dice_coef, dice_coe] #f1_m, precision_m, recall_m
    )
    return model
