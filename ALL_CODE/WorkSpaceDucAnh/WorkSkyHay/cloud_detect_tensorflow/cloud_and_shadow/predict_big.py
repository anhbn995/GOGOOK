...
def predict_all_2(base_path,outputFileName, model, n_classes = 1, postprocess=False):
    ...
    '''
        ...
        Params recommend to modify: kerel size, iterations
    '''
    if postprocess:
    ...
    new_dataset = rasterio.open(outputFileName, 'w', driver='GTiff',
                                ...
                                compress='lzw')        
    # new_dataset.write(opening[0], i+1)
    # for i in range(n_classes):
    #     new_dataset.write(opening[i], i+1)
...
if __name__ == '__main__':
    img_data = r"/home/geoai/eodata/cloud_detect_tensorflow/raw_img/shadow/sentinel_1 (2).tif"
    ...
    # img_data = r"/home/geoai/eodata/cloud_detect_tensorflow/cloud_and_shadow/data/predict.tif"
    output_im = r"/home/geoai/eodata/cloud_detect_tensorflow/cloud_and_shadow/data/out_new_band6.tif"
    FN_MODEL = r"/home/geoai/eodata/cloud_detect_tensorflow/cloud_and_shadow/final.h5"

    unet = build_model((None,None,4), 36)
    logging.info("Loading model {}".format(unet.name))
    unet.load_weights(FN_MODEL)
    logging.info("Model loaded !")
    
    predict_all_2(img_data, output_im, model=unet, n_classes = 1, postprocess=False)
