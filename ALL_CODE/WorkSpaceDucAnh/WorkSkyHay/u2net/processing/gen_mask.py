...
list_fp_img = glob.glob(os.path.join(r"/home/skymap/data/Bahrain_change/set4/shp_Set4/image_set1234_8band", "*.tif"))
for image in list_fp_img:
    ...
    for img in glob.glob(image):
        ...
        shp = os.path.join(r"/home/skymap/data/Bahrain_change/set4/shp_Set4/all_shp_building_s1234",os.path.basename(img).replace('tif','shp'))
        ...
        out_label = img.replace('.tif', '_mask_building_4band.tif')
