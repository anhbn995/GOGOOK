...
if __name__=="__main__":
    model_path = r"/home/skm/SKM16/X/Data_MachineLearning/V2_sentinel/training_dataset/model/building.h5"
    folder_image_path = r'/home/skm/SKM16/Tmp/HIEEU/test'
    folder_output_path = r'/home/skm/SKM16/Tmp/HIEEU/predict_building'
    ...
    model_size = 128
    num_bands = 4
    model = unet_basic((model_size, model_size, num_bands))
    ...
    for image_path in tqdm(list_image):
        ...
        if not os.path.exists(outputpredict):
            predict(model, fp_img, outputpredict, model_size)
        else:
            pass