...
def get_inria_aerial_folds(config, root_dir, folds):
    ...
    from pytorch_lydorn.torch_lydorn.torchvision.datasets import InriaAerial
...
def get_luxcarta_buildings(config, root_dir, folds):
    ...
    from pytorch_lydorn.torch_lydorn.torchvision.datasets import LuxcartaBuildings
...
def get_mapping_challenge(config, root_dir, folds):
    ...
    from pytorch_lydorn.torch_lydorn.torchvision.datasets import MappingChallenge
...
def get_opencities_competition(config, root_dir, folds):
    ...
    from pytorch_lydorn.torch_lydorn.torchvision.datasets import RasterizedOpenCities, OpenCitiesTestDataset
...
def get_xview2_dataset(config, root_dir, folds):
    ...
    from pytorch_lydorn.torch_lydorn.torchvision.datasets import xView2Dataset
