...
def inference_from_filepath(config, in_filepaths, backbone, out_dirpath=None):
    ...
    import glob
    print(in_filepaths)
    in_filepaths = glob.glob(os.path.join(in_filepaths[0], "predict/*.tif"))
    print("File list:")
    for i in in_filepaths: print(i)
    ###########################
    ###########################
    ...
    for in_filepath in pbar:
        ...
        # in_filepath = r"/home/skymap/data/building_extraction_torch/data/test/000000000000.jpg"
        # print(in_filepath)
        # import sys
        # sys.exit(0)
