...
def get_all_polygon(shape_filepath, shape_list):
    ...
    for shape_name in shape_list:
        ...
        epsr1 = 3785
        list_list_point_convert_ring0 = epsr1_to_epsr2(epsr1,3785,shapes_list_ring0)
        my_shapes_list_ring0.extend(list_list_point_convert_ring0)
        # if shape_name=="Road_A_06":
        #     # print(list_list_point_convert_ring0)
        list_list_point_convert_ring_oth = epsr1_to_epsr2(epsr1,3785,shapes_list_ring_oth)
...
def create_mask(image_id, img_dir, path_create,my_shapes_list_ring0,my_shapes_list_ring_oth):
    ...
    list_list_point_cv_ring0 = epsr1_to_epsr2(3785,epsr2,my_shapes_list_ring0)
    print(list_list_point_cv_ring0)
    list_list_point_cv_ring_oth = epsr1_to_epsr2(3785,epsr2,my_shapes_list_ring_oth)
