...
def main(image_dir,box_dir,label_dir,out_dir):
    ...
    out_data_image_crop_base = main_gen_data_with_size(img_cut_dir,img_cut_mask_dir,out_data_image_crop,sampleSize=512)
    out_dir_data_final = os.path.join(out_dir,"data_result")

    path_train,path_val,path_test = main_split(out_data_image_crop_base,split,out_dir_data_final)
...
if __name__ == "__main__":
    ...
    box_dir = os.path.abspath(sys.argv[2])
    label_dir = os.path.abspath(sys.argv[3])
